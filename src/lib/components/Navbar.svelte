<header class="shadow-sm">
	<div class="flex items-center justify-between h-16 px-4 mx-auto max-w-screen-xl">
		...
		<div class="flex items-center space-x-4">
			<span class="w-28 h-10 rounded-lg flex items-center content-center">
				<img src="/logo.png" alt="BrowserPlay Logo" class="m-auto">
			</span>
			
			<div class="hidden w-0 lg:flex">
			...
			<form class="hidden mb-0 lg:hidden -lg:flex">
				<div class="relative">
					<input
	...
	<div class="border-t border-gray-100 lg:hidden">
		<nav class="flex items-center justify-center p-4 overflow-x-auto text-sm font-medium">
			<a class="flex-shrink-0 pl-4 text-gray-900" href="/">Home</a>
		</nav>
	</div>
</header>
